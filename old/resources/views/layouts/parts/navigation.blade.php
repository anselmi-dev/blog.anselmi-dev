        ...
        <div
            ...
            <div class="z-10 sticky top-0 h-screen">
                <div class="w-10 lg:w-13 lg:top-0 py-5 lg:py-6 flex lg:flex-none items-center lg:whitespace-nowrap lg:text-sm leading-7 [writing-mode:vertical-rl] h-full flex-row">
                    ...
                    --}}
                    <div class="flex-row flex space-y-3">
                        <a href="https://www.linkedin.com/in/carlos-anselmi/"  target="__blank" title="Linkedin" class="text-gray-500 hover:text-white transition-all">
                        ...
                        <a href="https://x.com/AnselmiCarlos" target="__blank" title="Instagram" class="text-gray-500 hover:text-white transition-all">
                        ...
                        <a href="https://github.com/anselmi-dev"  target="__blank" title="Instagram" class="text-gray-500 hover:text-white transition-all">
