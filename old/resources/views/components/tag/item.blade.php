...
<a class="bg-gray-app dark:bg-zinc-800/90 hover:bg-app-primary rounded-sm px-1 md:px-2 mb-1 md:mb-2 text-white | mr-1 text-xs md:text-sm font-medium uppercase leading-6 group/tag"
    href="{{ $tag->url }}"
