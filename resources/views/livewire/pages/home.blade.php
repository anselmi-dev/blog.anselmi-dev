            ...
            <div class="flex flex-col space-y-12">
                ...
                <x-containers.card class="col-span-full">
                    <x-containers.card-section>
                        ...
                        <div class="space-y-4 | flex flex-wrap md:flex-nowrap md:space-x-4 md:space-y-0 | x-text-base-color text-sm">
                            <div class="w-full md:w-6/12">
                                ...
                                <br>
                                <br>
                                Desde que descubrí Laravel en 2018, sentí que había encontrado mi herramienta ideal en el desarrollo web. Desde entonces, he trabajado en proyectos que van desde sistemas de gestión integrados con AWS hasta e-commerce completos.
                            </div>
                            <div class="w-full md:w-6/12">
                                <div class="p-2 bg-gray-100/50 dark:text-white dark:bg-gray-app rounded">
                                    <p>Estas son algunas de las tecnologías con las que me divierto (y peleo) día a día:</p>
                                    ...
                                    <span>Además, últimamente estoy ampliando mis horizontes explorando tecnologías como <x-tooltip-like.card item="electron" label="Electron JS"/>. Porque, ya sabes, PHP está muriendo (sarcasmo, PHP nunca muere)</span>
                                </div>
                            </div>
                        </div>
                    </x-containers.card-section>
                        ...
                        <x-containers.card-section :title="__('What I am reading')">
                            ...
                            <span>
                                <div class="bg-gray-app h-[152px] rounded p-2 text-white z-1 relative overflow-hidden">
                                    {{-- <x-card.external-link/> --}}
                                    <div class="relative rounded-md text-xl pr-10 z-1">
                                        <i>Manual de Estoicismo</i>
                                        <br>
                                        - EPICTETO
                                    </div>
                                    <img src="{{ asset('images/books/manual-del-estoicismo.jpg') }}" alt="Manual de Estoicismo - EPICTETO" class="card-book__image">
                                </div>
                            </span>
                        </x-containers.card-section>
                    </x-containers.card>
