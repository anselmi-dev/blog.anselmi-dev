...
<div class="flex flex-col gap-40 mt-20">
    <x-containers.content>
        <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12 gap-x-12">
            ...
            <div class="_lg:order-first _lg:row-span-2">
                ...
                <div class="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                    {{-- <p>
                        Mi trayectoria en el desarrollo Full-Stack me ha permitido adquirir conocimientos y habilidades tanto en el front-end como en el back-end.
                    </p> --}}
                    <p>
        ...
        <div class="w-full text-center flex flex-wrap gap-2 justify-center">
            <a class="x-button-animation"
    ...
    <section id="features" aria-label="Features for running your books"
        class="relative overflow-hidden bg-primary-default pb-28 pt-20 sm:py-32 w-full"><img alt=""
