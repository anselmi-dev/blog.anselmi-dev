...
<div class="expanding-cards--card | h-[400px] md:h-[200px] bg-gray-200 flex-1 transition-all hover:flex-3 hover:bg-gray-300 w-[50%] duration-300 ease-in-out  group">
